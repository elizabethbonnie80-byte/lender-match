...
export async function getDealFull(supabase: DB, dealId: string): Promise<LenderDealListItem | null> {
  ...
  return {
    ...
    mobileHomeYearBuilt: data.mobile_home_year_built,
    mobileHomeHasCsaSeal: data.mobile_home_has_csa_seal ?? false,
    mobileHomeCsaSealYear: data.mobile_home_csa_seal_year,
